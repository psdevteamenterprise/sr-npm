...
export { CreateIndexRequest, CreateIndexResponse, DropIndexRequest, DropIndexResponse, Environment, Failure, Field, IndexSource, ListAvailableIndexesRequest, ListIndexesRequest, Order, Paging, PagingMetadata, Status } from './index.typings.mjs';
...
interface ListAvailableIndexesSignature {
     ...
     */
    (dataCollectionId: string): Promise<NonNullablePaths<ListAvailableIndexesResponse, `regular1Field` | `regular3Field` | `unique1Field`>>;
}
