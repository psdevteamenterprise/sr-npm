 ...
 */
declare function restoreDataCollection(dataCollectionId: string): Promise<NonNullablePaths<RestoreDataCollectionResponse, {
 ...
 */
declare function createDataCollectionField(dataCollectionId: string, options: NonNullablePaths<CreateDataCollectionFieldOptions, `field`>): Promise<NonNullablePaths<CreateDataCollectionFieldResponse, {
    [P in DataCollectionNonNullablePaths]: `dataCollection.${P}`;
}[DataCollectionNonNullablePaths]>>;
 ...
 */
declare function updateDataCollectionField(dataCollectionId: string, options: NonNullablePaths<UpdateDataCollectionFieldOptions, `field`>): Promise<NonNullablePaths<UpdateDataCollectionFieldResponse, {
    [P in DataCollectionNonNullablePaths]: `dataCollection.${P}`;
}[DataCollectionNonNullablePaths]>>;
 ...
 */
declare function deleteDataCollectionField(dataCollectionId: string, options: NonNullablePaths<DeleteDataCollectionFieldOptions, `fieldKey`>): Promise<NonNullablePaths<DeleteDataCollectionFieldResponse, {
    [P in DataCollectionNonNullablePaths]: `dataCollection.${P}`;
}[DataCollectionNonNullablePaths]>>;
